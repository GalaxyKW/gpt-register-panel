    ...
    + reconciliationConstants + '\n' + reconciliationContract + `
      result = {
        ...
        importReview: reconciliationTargetIsValid('token_import', {
          sourcePath: 'tokens/free00001.json',
          remoteAccountId: 266,
          action: 'update',
          accessFingerprint: 'a'.repeat(16),
          strongIdentityKeys: ['account:account-266'],
        ...
        clockReview: reconciliationTargetIsValid('token_import', {
          sourcePath: 'tokens/free00002.json',
          remoteAccountId: 267,
          action: 'update',
          accessFingerprint: 'd'.repeat(16),
          strongIdentityKeys: ['account:account-267'],
